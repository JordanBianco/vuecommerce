                ...
                <div class="mt-14">
                    ...
                    <!-- <router-link
                        ...
                        class="flex items-center space-x-3 p-2">
                            ...
                            <span class="whitespace-nowrap" v-if="isOpen">Ordini</span>
                    </router-link>

                    <router-link
                        :class="{ 'bg-gradient-to-r from-blue-400 to-blue-500 rounded-lg text-white shadow' : $route.name == 'My Address'}"
                        :to="{ name: 'My Address' }"
                        class="flex items-center space-x-3 p-2">
                            ...
                            <span class="whitespace-nowrap" v-if="isOpen">Articoli</span>
                    </router-link>
                    ...
                    <router-link
                        :class="{ 'bg-gradient-to-r from-blue-400 to-blue-500 rounded-lg text-white shadow' : $route.name == 'My Reviews'}"
                        :to="{ name: 'My Reviews' }"
                        class="flex items-center space-x-3 p-2">
                            ...
                            <span class="whitespace-nowrap" v-if="isOpen">Recensioni</span>
                    </router-link> -->
...
<!-- 
                    <router-link
                        :class="{ 'bg-gradient-to-r from-blue-400 to-blue-500 rounded-lg text-white shadow' : $route.name == 'Personal Info'}"
                    ...
                    <router-link
                        :class="{ 'bg-gradient-to-r from-blue-400 to-blue-500 rounded-lg text-white shadow' : $route.name == 'Change Password'}"
