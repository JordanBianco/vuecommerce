<template>
    <div>
        <header class="bg-gray-100 flex justify-end text-sm px-6 py-4 text-gray-600">
        ...
        <section class="p-6 space-y-4 text-sm">
            ...
            <div class="w-full">
                ...
                <textarea
                    ...
                    class="border border-gray-200 focus:ring-gray-300 w-full rounded-lg p-2 py-1.5 text-sm"></textarea>                    
