        ...
        <section class="flex items-center justify-between md:w-11/12 md:mx-auto px-4 md:px-0">
            ...
            <div class="w-3/4 flex items-center space-x-4">
                <div class="flex space-x-2 items-center">
                    ...
                    <router-link :to="{ name: 'Home' }">
                        <h1 class="uppercase font-semibold text-c-dark-gray">Vuecommerce</h1>
                    </router-link>
                </div>
                ...
                <div class="items-center space-x-4 text-sm hidden lg:flex font-thin">
                    ...
                    <div class="text-gray-300">Plant Care</div>
                    <div class="text-gray-300">Workshops</div>
                    <div class="text-gray-300">Blog</div>
                </div>
            </div>
            ...
            <div class="w-1/4 flex items-center space-x-4 justify-end">
                ...
                <div class="cursor-pointer">
                    <svg class="text-gray-400 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M15.71,12.71a6,6,0,1,0-7.42,0,10,10,0,0,0-6.22,8.18,1,1,0,0,0,2,.22,8,8,0,0,1,15.9,0,1,1,0,0,0,1,.89h.11a1,1,0,0,0,.88-1.1A10,10,0,0,0,15.71,12.71ZM12,12a4,4,0,1,1,4-4A4,4,0,0,1,12,12Z"/></svg>
                </div>
