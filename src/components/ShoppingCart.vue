<template>
    <aside
        ...
        class="md:w-72 lg:w-80 w-full overflow-x-hidden fixed transform duration-200 right-0 bottom-0 top-0 h-screen bg-gray-50 text-c-dark-gray z-50">
                ...
                <div class="bg-gray-100 p-6">
                    <div class="flex justify-center ">
                        <router-link
                            ...
                            :to="{ name: 'cart.show' }"
                            class="max-w-max text-sm text-c-light-gray hover:text-c-dark-gray mb-2">
                                modifica carrello
                        </router-link>
                    </div>
                    <div class="flex justify-center">
                        <div class="flex items-center space-x-2 bg-c-green rounded-lg max-w-max py-2 px-4">
