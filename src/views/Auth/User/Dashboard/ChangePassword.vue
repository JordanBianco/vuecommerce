    ...
    <div>
        ...
        <form @submit.prevent="changePassword()">    
            ...
            <div class="w-full mb-6">
                <label class="text-gray-400 text-xs" for="oldPassword">{{ $t('old_password') }}</label>
                <input
                    type="password"
            ...
            <!-- Nuova Password -->
            <div class="w-full mb-6">
                <label class="text-gray-400 text-xs" for="newPassword">{{ $t('new_password') }}</label>
                <input
                    type="password"
            ...
            <div class="w-full mb-6">
                <label class="text-gray-400 text-xs" for="newPassword_confirmation">{{ $t('confirm_password') }}</label>
                <input
                    type="password"
