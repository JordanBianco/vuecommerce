<template>
    <div>
        <div v-if="product" class="flex flex-col md:flex-row md:w-10/12 md:mx-auto md:space-x-6 p-4 md:pt-20">
            ...
            <section class="p-4 md:p-0 md:w-1/2">
                ...
                <div class="md:flex md:items-center md:space-x-2 hidden mt-8">
                    <!-- Add to cart -->
                    <button
                        @click="addToCart()"
                        class="bg-c-green rounded-lg px-4 py-2 flex items-center space-x-2 text-c-white text-sm max-w-max">
                            <span>Aggiungi al carrello</span>
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M19,7H16V6A4,4,0,0,0,8,6V7H5A1,1,0,0,0,4,8V19a3,3,0,0,0,3,3H17a3,3,0,0,0,3-3V8A1,1,0,0,0,19,7ZM10,6a2,2,0,0,1,4,0V7H10Zm8,13a1,1,0,0,1-1,1H7a1,1,0,0,1-1-1V9H8v1a1,1,0,0,0,2,0V9h4v1a1,1,0,0,0,2,0V9h2Z"/></svg>
                    </button>
                    <!-- Save Item -->
                    <div
